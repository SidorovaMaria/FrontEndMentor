        ...
        <div className="relative w-[130px] h-[130px] lg:w-[190px] lg:h-[190px]">
          ...
          <AnimatePresence>
            {showComputerChoice && (
              ...
              >
                <ChosenBtn
                  borderColor={signFeatures[state.computerChoice].borderColor}
                  shadowColor={signFeatures[state.computerChoice].shadowColor}
                  icon={signFeatures[state.computerChoice].icon}
                  won={state.winner === signFeatures[state.computerChoice].icon}
                />
              </motion.div>
            )}
          </AnimatePresence>
