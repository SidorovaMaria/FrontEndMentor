...
import { setWinnerTimeLost, updateTimer } from "../features/gameSlice";

const TurnMarker = () => {
  const { currentPlayer, timer, timerStopped } = useSelector(
    (state) => state.game
  );
    ...
    <AnimatePresence>
      {currentPlayer && (
        ...
        >
          ...
          <div
            className={`${
              currentPlayer.color === "red" ? "text-white" : "text-black"
